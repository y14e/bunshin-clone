...
// CDNs
import { bunshinClone } from 'https://esm.sh/bunshin-clone@1.2.9';
// or
import { bunshinClone } from 'https://cdn.jsdelivr.net/npm/bunshin-clone@1.2.9/+esm';
// or
import { bunshinClone } from 'https://esm.unpkg.com/bunshin-clone@1.2.9';
```
