...
// CDNs
import { bunshinClone } from 'https://esm.sh/bunshin-clone@1.3.0';
// or
import { bunshinClone } from 'https://cdn.jsdelivr.net/npm/bunshin-clone@1.3.0/+esm';
// or
import { bunshinClone } from 'https://esm.unpkg.com/bunshin-clone@1.3.0';
```
